...
<div class="page-header">
    <h1 class="page-title"><i class="fa-solid fa-plus me-2" style="color:#4f46e5;"></i>Add Academic Year</h1>
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('admin.setup.academic-years.store') }}">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">Year Name <span class="text-danger">*</span></label>
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                               value="{{ old('name') }}" placeholder="e.g. 2024-25" required>
                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            <input type="checkbox" name="is_current" value="1" class="form-check-input" id="is_current" {{ old('is_current') ? 'checked' : '' }}>
